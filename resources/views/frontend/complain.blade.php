...
@endsection
@section('content')
<h1 class="mb-2 text-center">Send your Complain</h1>
		...
		<div class="col-md-8">
			<div class="margin_top">
				<form action="{{route('contact')}}" class="form-horizontal" role="form" method="POST" >
			        ...
			        <div class="form-group">
			            <label class="col-sm-3 control-label">Complain</label>
			            <div class="col-md-8">
			        ...
			        <div class="form-group">
			            ...
			            <div class="col-md-8">
			                <button type="submit" class="btn btn-success" value="Send" name="send">Submit your complain</button>
			            </div>
			        </div>
			    </form>
		    </div>
