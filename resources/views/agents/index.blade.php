...
@section('content')
    <div class="row">
        <div class="col-lg-12 margin-tb">
            ...
            <div class="pull-right">
                <a class="btn btn-success" href="{{ route('agents.create') }}"> Create new Agents</a>
            </div>
        </div>
    </div>
    <!----------------------search start-------------------------->
    <div class="row">
        <div class="col-lg-4">
            {!! Form::open(array('route' => 'agents.index','method'=>'GET')) !!}
                    ...
                    @foreach ($members as $key => $member)
                        <tr>
                            ...
                            <td>
                                ...
                                <a class="btn btn-primary" href="{{ route('agents.edit',$member->id) }}">Agent buy ticket</a>
                                {!! Form::open(['method' => 'DELETE','route' => ['agents.destroy', $member->id],'style'=>'display:inline', 'class'=>'delete']) !!}
