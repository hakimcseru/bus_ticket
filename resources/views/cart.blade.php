                    ...
                    <tr>
                        <td class="table-image">
                            ...
                            <a href="{{ route('single.show',$item->model->id) }}">
                                <img src="{{Request::root()}}/uploads/books/{{ $item->model->cover_photo }}"  class="img-responsive cart-image" alt="book" width="50">
                            </a>
                        </td>
                        <td>
                            Book Name:{{ $item->model->title }}<br>
