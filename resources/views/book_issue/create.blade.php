<?php
/*        echo "<pre>";
print_r($insertData['selectedbook']->id);
exit();*/
?>
@extends('layouts.app')
@section('owncss')
...
@section('content')
    <div class="row">
        <div class="col-lg-12 margin-tb">
            <div class="pull-left">
                <h2>Book or Journal seminar Issue</h2>
            </div>
...
@section('ownjs')
    ...
    <script type="text/javascript">
        ...
        function qrPopulateScan(qr) {
            ...
            //var qrStringInput = $('#qrStringId').val();
            var qrStringInput = qr;

            var qrString = qrStringInput.substr(qrStringInput.length - 10);
            ...
            if(qrString) {
                $.ajax({
                    ...
                    success:function(data) {
                        ...
                        $('select[name="copy_number"]').append('<option value="'+ qrStringInput +'">'+ qrStringInput +'</option>');
