            ...
            <div class="form-group">
               <strong>Permission:</strong>
                ...
                @foreach($permission as $value)
                        ...
                        {{ Form::checkbox('permission[]', $value->id, in_array($value->id, $rolePermissions) ? true : false, array('class' => "name filled-in chk-col-teal",'id'=>"md_checkbox$value->id")) }}
                    ...
                    <?php
                         foreach ($children as $key=>$singlechildren){
                            ...
                            foreach ($singlechildren as $des_singlechildren){
                               ?>
                                 <option value='{{$des_singlechildren->id}}' data-section="{{$key}}" <?php if(in_array($des_singlechildren->id, $rolePermissions)) { echo "selected"; } ?>>{{$des_singlechildren->name}}</option>
                              <?php
                            }
