...
@section('content')
    ...
    {!! Form::model($abnews, ['method' => 'PATCH','route' => ['albarakanews.update', $abnews->id],'files' => true]) !!}
                            ...
                            <div class="form-group form-float">
                                ...
                                <div class="input-group">
                                    <span class="input-group-addon" id="basic-addon1"><i class="fa fa-user" aria-hidden="true"></i></span>
                                     {!! Form::text('title', $abnews->title, array('placeholder' => 'Title', 'required' => 'required','class' => 'form-control')) !!}
                                </div>
                            </div>
                        </div>
                        <div class="col-xs-12 col-sm-12 col-md-12">
                            <div class="form-group form-float">
                                ...
                                <div class="input-group">
                                    <span class="input-group-addon" id="basic-addon1"><i class="fa fa-user" aria-hidden="true"></i></span>
                                     {!! Form::text('description', $abnews->description, array('placeholder' => 'Description', 'required' => 'required','class' => 'form-control')) !!}
                                </div>
                            </div>
                        </div>
